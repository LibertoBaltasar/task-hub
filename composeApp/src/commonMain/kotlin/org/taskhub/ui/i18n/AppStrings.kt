...
object AppStrings {
    ...
    private val strings: Map<String, Map<String, String>> = mapOf(
        "es" to mapOf(
            ...
            "calendar_status_no_due_date" to "📅 Sin fecha límite propia — no se sincroniza con Google Calendar",
        ...
        "en" to mapOf(
            ...
            "calendar_status_no_due_date" to "📅 No individual due date — won't sync to Google Calendar",
