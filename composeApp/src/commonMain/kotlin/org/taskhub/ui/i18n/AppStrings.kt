...
object AppStrings {
    ...
    private val strings: Map<String, Map<String, String>> = mapOf(
        "es" to mapOf(
            ...
            "settings_privacy_policy" to "Política de privacidad",
            ...
            "settings_delete_account_reauthenticating" to "Confirmando tu identidad…",
            ...
            "calendar_unlink_confirm_title" to "¿Desvincular Google Calendar?",
            "calendar_unlink_confirm_text" to "Dejarás de sincronizar tareas con tu Google Calendar. Puedes volver a vincularlo cuando quieras.",
            "calendar_independent_note" to "Cada espacio usa su propio calendario en Google (p. ej. \"Tareas personal\", \"Tareas Casa\").",
            "calendar_status_no_due_date" to "📅 Sin fecha — no se sincroniza con Google Calendar",
            ...
            "household_deleting_progress" to "Eliminando espacio…",
            "household_leaving_progress" to "Saliendo del espacio…",
            ...
            // porque solo existía el grupo/estado "completada HOY").
            "tasks_completed_other" to "✅ Completadas",
            "tasks_due_today" to "Hoy",
            "tasks_overdue" to "Vencidas",
            "tasks_empty_pending" to "🎉 ¡No hay tareas pendientes!",
            "tasks_empty_completed" to "📋 No hay tareas completadas",
            "tasks_empty_mine" to "👤 No tienes tareas asignadas",
            "tasks_empty_all" to "📋 No hay tareas aún. ¡Crea la primera!",
            "tasks_error_loading" to "No se pudieron cargar tus espacios. Tira hacia abajo para reintentarlo.",
            ...
            "recurrence_next_preview" to "📅 Próxima vez: %s",
            ...
            "messages_label" to "Mensaje",
            "messages_hint" to "Escribe un mensaje…",
            "messages_empty" to "Aún no hay mensajes. ¡Escribe el primero!",
            "messages_error_loading" to "No se pudieron cargar los mensajes. Inténtalo de nuevo.",
            "messages_error_sending" to "No se pudo enviar el mensaje. Inténtalo de nuevo.",
            ...
            "transfer_amount_range_hint" to "Debe ser un número entre 1 y %d",
            ...
            // Desde `docs/mensajes-error-usuario-2026-09-16.md`: estas claves
            // solo se usan ya para el fallo ESPECÍFICO de la operación (4xx no
            // clasificable como sin acceso) — sin conexión/sin acceso/servidor
            // tienen su propio mensaje genérico común, ver más abajo
            // ("error_no_connection"/"error_gone_or_forbidden"/"error_server").
            "member_error_loading" to "No se pudieron cargar los miembros. Inténtalo de nuevo.",
            "member_error_adding" to "No se pudo añadir al miembro. Inténtalo de nuevo.",
            "member_error_removing" to "No se pudo eliminar al miembro. Inténtalo de nuevo.",
            "member_error_role" to "No se pudo cambiar el rol. Inténtalo de nuevo.",
            "reward_error_loading" to "No se pudieron cargar las recompensas. Inténtalo de nuevo.",
            "reward_error_creating" to "No se pudo crear la recompensa. Revisa los datos e inténtalo de nuevo.",
            "reward_error_deleting" to "No se pudo eliminar la recompensa. Inténtalo de nuevo.",
            "reward_error_redeeming" to "No se pudo canjear la recompensa. Inténtalo de nuevo.",
            "google_auth_error_sign_in" to "No se pudo iniciar sesión. Comprueba tu conexión y vuelve a intentarlo.",
            "profile_error_loading_own" to "No se pudo cargar tu perfil. Inténtalo de nuevo.",
            "profile_error_loading" to "No se pudo cargar el perfil. Inténtalo de nuevo.",
            "profile_error_saving" to "No se pudo guardar el perfil. Inténtalo de nuevo.",
            "profile_error_not_authenticated" to "No estás autenticado. Inicia sesión de nuevo para continuar.",
            "profile_default_name" to "Usuario",
            "notification_error_loading" to "No se pudieron cargar las notificaciones. Inténtalo de nuevo.",
            "task_error_loading" to "No se pudieron cargar las tareas. Tira hacia abajo para reintentarlo.",
            "task_error_creating" to "No se pudo crear la tarea. Revisa los datos e inténtalo de nuevo.",
            "task_error_completing" to "No se pudo completar la tarea. Inténtalo de nuevo.",
            "task_error_reassigning" to "No se pudo cambiar quién hizo la tarea. Inténtalo de nuevo.",
            "task_error_undo" to "No se pudo deshacer. La tarea puede seguir marcada como completada. Inténtalo de nuevo.",
            "task_error_loading_single" to "No se pudo cargar la tarea. Inténtalo de nuevo.",
            "task_error_assigning" to "No se pudo asignar la tarea. Inténtalo de nuevo.",
            "task_error_updating" to "No se pudieron guardar los cambios de la tarea. Inténtalo de nuevo.",
            "task_error_deleting" to "No se pudo eliminar la tarea. Inténtalo de nuevo.",
            "task_comment_error_loading" to "No se pudieron cargar los comentarios. Inténtalo de nuevo.",
            "task_comment_error_adding" to "No se pudo publicar el comentario. Inténtalo de nuevo.",
            "task_comment_default_author" to "Miembro",
            "calendar_sync_error" to "No se pudo sincronizar con Google Calendar. Inténtalo de nuevo.",
            "calendar_sync_no_assignment" to "No se pudo determinar tu asignación para esta tarea.",
            "household_error_creating" to "No se pudo crear el espacio. Inténtalo de nuevo.",
            "household_error_joining" to "No se pudo unir al espacio. Inténtalo de nuevo.",
            "household_error_invalid_invite_code" to "Código de invitación inválido. Revísalo e inténtalo de nuevo.",
            "household_error_loading" to "No se pudo cargar el espacio. Inténtalo de nuevo.",
            "household_error_deleting" to "No se pudo eliminar el espacio. Inténtalo de nuevo.",
            "household_error_deleting_cascade" to "No se pudieron borrar todos los datos del espacio. El espacio no se ha eliminado; puedes reintentarlo más tarde.",
            "household_error_leaving" to "No se pudo salir del espacio. Inténtalo de nuevo.",

            // Mensajes genéricos por CATEGORÍA de fallo de red (ver
            // `network/ErrorCategory.kt`): se usan en vez del mensaje
            // específico de la operación cuando el fallo es clasificable como
            // sin conexión, sin acceso al recurso o problema del servidor —
            // esas 3 causas son independientes de qué operación se intentaba.
            "error_no_connection" to "Sin conexión a internet. Comprueba tu conexión y vuelve a intentarlo.",
            "error_gone_or_forbidden" to "Este espacio ya no existe o ya no tienes acceso a él.",
            "error_server" to "Algo ha ido mal en el servidor. Inténtalo de nuevo en unos minutos.",
            ...
            "ranking_error_loading" to "No se pudieron cargar los miembros. Inténtalo de nuevo.",
            ...
            "join_household_code_hint" to "El código tiene al menos 4 caracteres",
            ...
            "calendar_pending_section_subtitle" to "Tareas sin fecha — no aparecen en el calendario",
            "calendar_pending_empty" to "No hay tareas sin fecha",
            "calendar_overdue_section" to "⏰ Caducadas",
            "calendar_overdue_empty" to "¡No hay tareas caducadas!",
            ...
            "create_task_success" to "Tarea creada",
            "edit_task_success" to "Tarea guardada",
            "create_reward_success" to "Recompensa creada",
            ...
            "create_task_creator_resolve_error" to "No se pudo identificar quién crea la tarea. Comprueba tu conexión.",
            "create_task_section_checklist" to "📋 Lista",
            "create_task_section_checklist_hint" to "Apunta lo que haga falta: pasos, compra, materiales…",
            "create_task_add_item" to "Añadir ítem",
            "create_task_tag_other_chip" to "+ Otra",
            "task_detail_other_section" to "Otros",
            ...
            "create_task_remove_tag_named" to "Eliminar etiqueta %s",
            ...
            "create_task_deadline_section" to "⏰ Fecha",
            "create_task_pick_date" to "Elegir fecha",
            "create_task_time_label" to "Hora (HH:MM)",
            "task_past_due_warning" to "⚠️ La fecha límite ya ha pasado",
            ...
            "create_task_penalty_requires_deadline_hint" to "Activa la fecha (en «Otros») para configurar la penalización por retraso.",
            ...
            "task_detail_recurrence_section" to "🔄 Recurrencia",
            ...
            "task_detail_checklist_header" to "📋 Lista (%1/%2)",
            ...
            "task_detail_comment_label" to "Comentario",
            ...
            "task_list_no_deadline" to "Sin fecha",
            "task_list_subtask_badge" to "📋 %1/%2",
            "task_list_search_label" to "Buscar",
            ...
            "task_list_sort_deadline_asc" to "Fecha más próxima",
            "task_list_sort_deadline_desc" to "Fecha más lejana",
        ...
        "en" to mapOf(
            ...
            "settings_delete_account_reauthenticating" to "Confirming your identity…",
            ...
            "calendar_unlink_confirm_title" to "Unlink Google Calendar?",
            "calendar_unlink_confirm_text" to "You'll stop syncing tasks with your Google Calendar. You can link it again anytime.",
            "calendar_independent_note" to "Each space uses its own Google calendar (e.g. \"Personal tasks\", \"Home tasks\").",
            "calendar_status_no_due_date" to "📅 No date — not synced with Google Calendar",
            ...
            "household_deleting_progress" to "Deleting space…",
            "household_leaving_progress" to "Leaving space…",
            ...
            "tasks_empty_completed" to "📋 No completed tasks",
            "tasks_empty_mine" to "👤 You have no assigned tasks",
            "tasks_empty_all" to "📋 No tasks yet. Create the first one!",
            "tasks_error_loading" to "Couldn't load your spaces. Pull down to try again.",
            ...
            "recurrence_next_preview" to "📅 Next time: %s",
            ...
            "messages_label" to "Message",
            "messages_hint" to "Write a message…",
            "messages_empty" to "No messages yet. Write the first one!",
            "messages_error_loading" to "Couldn't load messages. Please try again.",
            "messages_error_sending" to "Couldn't send the message. Please try again.",
            ...
            "transfer_amount_range_hint" to "Must be a number between 1 and %d",
            ...
            "transfer_error_uncertain" to "We couldn't confirm whether the transfer went through. Check your balance before retrying to avoid duplicating it.",
            "task_error_uncertain" to "We couldn't confirm whether the task was completed. Check its status before retrying to avoid duplicating the points.",
            ...
            "member_error_loading" to "Couldn't load members. Please try again.",
            "member_error_adding" to "Couldn't add the member. Please try again.",
            "member_error_removing" to "Couldn't remove the member. Please try again.",
            "member_error_role" to "Couldn't change the role. Please try again.",
            "reward_error_loading" to "Couldn't load rewards. Please try again.",
            "reward_error_creating" to "Couldn't create the reward. Check the details and try again.",
            "reward_error_deleting" to "Couldn't delete the reward. Please try again.",
            "reward_error_redeeming" to "Couldn't redeem the reward. Please try again.",
            "google_auth_error_sign_in" to "Couldn't sign in. Check your connection and try again.",
            "profile_error_loading_own" to "Couldn't load your profile. Please try again.",
            "profile_error_loading" to "Couldn't load the profile. Please try again.",
            "profile_error_saving" to "Couldn't save the profile. Please try again.",
            "profile_error_not_authenticated" to "You're not signed in. Sign in again to continue.",
            "profile_default_name" to "User",
            "notification_error_loading" to "Couldn't load notifications. Please try again.",
            "task_error_loading" to "Couldn't load tasks. Pull down to try again.",
            "task_error_creating" to "Couldn't create the task. Check the details and try again.",
            "task_error_completing" to "Couldn't complete the task. Please try again.",
            "task_error_reassigning" to "Couldn't change who did the task. Please try again.",
            "task_error_undo" to "Couldn't undo. The task may still be marked as completed. Please try again.",
            "task_error_loading_single" to "Couldn't load the task. Please try again.",
            "task_error_assigning" to "Couldn't assign the task. Please try again.",
            "task_error_updating" to "Couldn't save the task changes. Please try again.",
            "task_error_deleting" to "Couldn't delete the task. Please try again.",
            "task_comment_error_loading" to "Couldn't load comments. Please try again.",
            "task_comment_error_adding" to "Couldn't post the comment. Please try again.",
            "task_comment_default_author" to "Member",
            "calendar_sync_error" to "Couldn't sync with Google Calendar. Please try again.",
            "calendar_sync_no_assignment" to "Couldn't determine your assignment for this task.",
            "household_error_creating" to "Couldn't create the space. Please try again.",
            "household_error_joining" to "Couldn't join the space. Please try again.",
            "household_error_invalid_invite_code" to "Invalid invite code. Check it and try again.",
            "household_error_loading" to "Couldn't load the space. Please try again.",
            "household_error_deleting" to "Couldn't delete the space. Please try again.",
            "household_error_deleting_cascade" to "We couldn't delete all the space's data. The space was not deleted; you can try again later.",
            "household_error_leaving" to "Couldn't leave the space. Please try again.",

            "error_no_connection" to "No internet connection. Check your connection and try again.",
            "error_gone_or_forbidden" to "This space no longer exists or you no longer have access to it.",
            "error_server" to "Something went wrong on the server. Try again in a few minutes.",
            ...
            // Ranking (RankingScreen.kt)
            "ranking_error_loading" to "Couldn't load members. Please try again.",
            ...
            "join_household_code_hint" to "The code is at least 4 characters",
            ...
            "calendar_pending_section_subtitle" to "Tasks without a date — not shown on the calendar",
            "calendar_pending_empty" to "No tasks without a date",
            "calendar_overdue_section" to "⏰ Overdue",
            "calendar_overdue_empty" to "No overdue tasks!",
            ...
            "create_task_success" to "Task created",
            "edit_task_success" to "Task saved",
            "create_reward_success" to "Reward created",
            ...
            "create_task_creator_resolve_error" to "Couldn't identify who is creating the task. Check your connection.",
            "create_task_section_checklist" to "📋 List",
            "create_task_section_checklist_hint" to "Add whatever you need: steps, shopping, supplies…",
            "create_task_add_item" to "Add item",
            "create_task_tag_other_chip" to "+ Other",
            "task_detail_other_section" to "Other",
            ...
            "create_task_remove_tag_named" to "Remove tag %s",
            ...
            "create_task_deadline_section" to "📅 Date",
            "create_task_pick_date" to "Pick a date",
            "create_task_time_label" to "Time (HH:MM)",
            "task_past_due_warning" to "⚠️ The due date has already passed",
            ...
            "create_task_penalty_requires_deadline_hint" to "Enable the date (in \"Other\") to configure the late penalty.",
            ...
            "task_detail_recurrence_section" to "🔄 Recurrence",
            ...
            "task_detail_checklist_header" to "📋 List (%1/%2)",
            ...
            "task_detail_comment_label" to "Comment",
            ...
            "task_list_no_deadline" to "No date",
            "task_list_subtask_badge" to "📋 %1/%2",
            "task_list_search_label" to "Search",
            ...
            "task_list_sort_deadline_asc" to "Closest date",
            "task_list_sort_deadline_desc" to "Farthest date",
